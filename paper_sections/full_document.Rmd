...
All code and data used to generate this paper are available at: [github.com/noamross/mixed-effect-gams](https://github.com/noamross/mixed-effect-gams). 
...
EJP was funded by National Science and Engineering Research Council of Canada (NSERC) and Fisheries and Oceans Canada.
GLS is funded by a Natural Science and Engineering Research Council of Canada (NSERC) Discovery Grant (RGPIN-2014-04032).
DLM was partly funded by OPNAV N45 and the SURTASS LFA Settlement Agreement, managed by the U.S. Navy's Living Marine Resources program under Contract No. N39430-17-C-1982.
