...
kable(round(k.check(zoo_comm_modI),2), 
      ...
      caption="Results from running `k.check` on zoo_comm_modI.", 
      booktabs = TRUE,
      escape = FALSE)%>%
...
zoo_plot <- ggplot(zoo_plot_data) +
  ...
  labs(y = expression(atop(Population~density,("10 000"~individuals~m^{-2}))), 
    ...
    scale_fill_brewer(name = "", palette = "Dark2",
                      labels = paste("Model", c("S","I"))) +
    scale_colour_brewer(name = "",
                        palette = "Dark2", labels = paste("Model", c("S","I")))+
...
daph_plot <- ggplot(daph_plot_data, aes(x=day))+
  ...
  scale_x_continuous(expand = c(0,0))+
    scale_fill_brewer(name = "", palette = "Dark2",
                      labels = paste("Model", c("G","GS","GI"))) +
    scale_colour_brewer(name = "",
                        palette = "Dark2", labels = paste("Model", c("G","GS","GI")))
