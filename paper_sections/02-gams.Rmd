...
**EJP: I think we should avoid a lot of the mathematical detail; we can just refer to Simon's papers for interested readers.** 
...
**Should we include sample code for each smoother here? As this is a tutorial paper, it may help the reader**
