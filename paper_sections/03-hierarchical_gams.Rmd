...
The combination of these three questions results in five possible models (Figure \ref{fig:models}) beyond the null model of no functional relation between **x** and **y**:
