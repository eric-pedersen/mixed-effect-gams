...
We have just plotted a subsample of the group-specific smooths from this model, to prevent crowding. It is appearent from this that some groups (e.g. Qc1, Mn2) have very similar shapes to the global smooth (differing only in intercept), whereas others, such as Mc3, do differ from the global trend, with higher uptake at low concentrations, and lower uptake at higher concentrations.
