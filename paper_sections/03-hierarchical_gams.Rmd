...
where $\zeta_\texttt{Plant\_uo}$ is the random effect for plant and $\epsilon_i$ is a Gaussian error term. Here we assume that $\log_e(\texttt{uptake}_i)$ is normally distributed.
...
multivariate equivalent of the factor smooth; it requires more smooth terms than
