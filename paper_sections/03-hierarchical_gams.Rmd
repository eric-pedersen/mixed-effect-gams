...
plot(CO2_mod3,scale=0,select=1, ylab = "global smooth")
plot(CO2_mod3,scale=0,select=14,ylab = "Intercepts",main=NA)
plot(CO2_mod3,scale=0,select=2, ylab = "Plant Qn1")
plot(CO2_mod3,scale=0,select=5, ylab = "Plant Qc1")
plot(CO2_mod3,scale=0,select=9, ylab = "Plant Mn2")
plot(CO2_mod3,scale=0,select=12,ylab = "Plant Mc3")
