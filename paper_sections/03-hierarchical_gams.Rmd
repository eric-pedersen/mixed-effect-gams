...
will typically be much more variable than from model 2, as there is no way for the model to share information on function shape between grouping levels without the global smooth term. See section IV on computational issues for more on how to choose between different models.
