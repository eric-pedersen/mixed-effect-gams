...
For instance, the AIC for model *S* fit to this data is `r round(AIC(modG))`, whereas it is `r round(AIC(modGS))` for model *I*, implying a improvement in fit by allowing smoothness to vary.
