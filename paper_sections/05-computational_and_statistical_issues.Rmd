...
variable; `gamm` only supports non-Gaussian families by using a fititng method
...
several of the extended families avaiable through `mgcv`, such as zero-inflated,
negative binomial, or ordered catagorical and multinomial distributions. 
...
effects can be fitted). We have noted, however, that `mgcv` still occassionally
