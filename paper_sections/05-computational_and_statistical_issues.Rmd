...
biasvar_data = crossing(noise = noise_levels,
  ...
  mutate(y = sin(freq*x) +rnorm(n(), 0, noise),
...
biasvar_predict_fit = biasvar_fit %>%
  ...
  mutate(noise = paste0("noise Std. Dev. = ", noise),
         noise = factor(noise, 
                        levels = paste0("noise Std. Dev. = ",noise_levels)))
