...
As noted above[^te_concurvity], interpreting the shape of global terms and group-wise deviations seperately for  *GS* models fit using tensor-product group-level terms is complicated by the fact that **mgcv** will drop some basis-functions for the group-level term to prevent perfect concurvity. 
