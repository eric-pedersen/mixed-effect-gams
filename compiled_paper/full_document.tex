...
\begin{figure}
\includegraphics[width=\linewidth]{../figures/Fig10} \caption{\label{fig:co2_modGS}Global function (left) and group-specific deviations from the global function (right) for \texttt{CO2\_modGS}}\label{fig:Fig10}
\end{figure}
...
\hspace{1em}G & 1 & 17 & 2\\
\hspace{1em}GS & 6 & 65 & 3\\
\hspace{1em}GI & 12 & 65 & 14\\
\hspace{1em}S & 5 & 61 & 3\\
\hspace{1em}I & 12 & 61 & 13\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{B. Bird movement data}}\\
\hspace{1em}G & 1 & 90 & 2\\
\hspace{1em}GS & 490 & 540 & 8\\
\hspace{1em}GI & 400 & 624 & 14\\
\hspace{1em}S & 810 & 541 & 6\\
\hspace{1em}I & 72 & 535 & 12\\
\bottomrule
\end{tabular}
\end{table}
