...
group-level smoothers are necessary. However, we do not currently
...
and QQ-plots are similar to the those from the zooplankton community
...
\hspace{1em}G & 1 & 17 & 2\\
\hspace{1em}GS & 17 & 65 & 3\\
\hspace{1em}GI & 55 & 65 & 14\\
\hspace{1em}S & 13 & 61 & 3\\
\hspace{1em}I & 39 & 61 & 13\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{B. Bird movement data}}\\
\hspace{1em}G & 1 & 90 & 2\\
\hspace{1em}GS & 540 & 540 & 8\\
\hspace{1em}GI & 430 & 624 & 14\\
\hspace{1em}S & 900 & 541 & 6\\
...
compared to the global term, this encodes the assumption that the global
